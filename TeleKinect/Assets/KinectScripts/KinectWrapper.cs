...
public class KinectWrapper
{
    ...
    public static string serverHost = "169.254.80.80:12345";
    ...
    public static WWW QueryServer(string urlParams)
    {
        WWW req = new WWW("http://" + serverHost + urlParams);
        int i = 0;
        while (!req.isDone)
        {
            i++;
	...
	public static int InitKinectSensor(NuiInitializeFlags dwFlags, bool bEnableEvents, int iColorResolution, int iDepthResolution, bool bNearMode)
	{
		throw new NotImplementedException();
	}

	// [DllImportAttribute(@"KinectUnityWrapper.dll", EntryPoint = "EnableKinectManager")]
	public static void EnableKinectManager(bool bEnable)
	{
	throw new NotImplementedException();
	}

	// [DllImportAttribute(@"KinectUnityWrapper.dll", EntryPoint = "UpdateKinectSensor")]
	public static int UpdateKinectSensor()
	{
	throw new NotImplementedException();
	}
#else
    ...
    {
        //WWW req = QueryServer("?method=NuiInitialize");
        WWW req = new WWW("http://169.254.80.80:12345?method=NuiInitialize");
	...
	public static int SetKinectElevationAngle(int sensorAngle)
	{
	    throw new NotImplementedException();
	}

	// [DllImportAttribute(@"KinectUnityWrapper.dll", EntryPoint = "GetKinectElevationAngle")]
	public static int GetKinectElevationAngle()
	{
	    throw new NotImplementedException();
	}
...
#else
    // [DllImportAttribute(@"KinectUnityWrapper.dll", EntryPoint, EntryPoint = "NuiShutdown")]
    public static void NuiShutdown()
    {
        QueryServer("?method=NuiShutdown");
    }

    // [DllImportAttribute(@"Kinect10.dll", EntryPoint = "NuiCameraElevationSetAngle")]
    public static int NuiCameraElevationSetAngle(int angle)
    {
        WWW req = QueryServer("?method=NuiCameraElevationSetAngle&angle=" + angle.ToString());
        return int.Parse(req.text);
    }
    ...
    public static int NuiCameraElevationGetAngle(out int plAngleDegrees)
    {
        WWW req = QueryServer("?method=NuiCameraElevationGetAngle");
        plAngleDegrees = int.Parse(req.text.Split(',')[1]);
    ...
    public static int NuiGetSensorCount(out int pCount)
    {
        WWW req = QueryServer("?method=NuiGetSensorCount");
        pCount = int.Parse(req.text.Split(',')[1]);
        return int.Parse(req.text.Split(',')[0]);
    }
    ...
    public static int NuiSkeletonTrackingEnable(IntPtr hNextFrameEvent, uint dwFlags)
    {
        WWW req = QueryServer("?method=NuiSkeletonTrackingEnable&hNextFrameEvent=" + hNextFrameEvent.ToString() + "&dwFlags=" + dwFlags.ToString());
	...
	public static int GetSkeletonFrameLength()
	{
		throw new NotImplementedException();
	}

	// [DllImport(@"KinectUnityWrapper.dll", EntryPoint = "GetSkeletonFrameData")]
	public static bool GetSkeletonFrameData(ref NuiSkeletonFrame pSkeletonData, ref uint iDataBufLen, bool bNewFrame)
	{
		throw new NotImplementedException();
	}

	// [DllImport(@"KinectUnityWrapper.dll", EntryPoint = "GetNextSkeletonFrame")]
	public static int GetNextSkeletonFrame(uint dwWaitMs)
    ...
    static string SkeletonDataToString(NuiSkeletonData data)
    {
        ...
        string retStr = data.eTrackingState.ToString() + "," + 
            data.dwTrackingID.ToString() + "," + 
            data.dwEnrollmentIndex_NotUsed.ToString() + "," + 
            data.dwUserIndex.ToString() + "," + 
            data.Position.x.ToString() + "," + 
            data.Position.y.ToString() + "," + 
            data.Position.z.ToString() + "," + 
            data.Position.w.ToString() + ","
            ;
        
        for(int i = 0; i < 20; i++)
        {
            retStr += data.SkeletonPositions[i].x.ToString() + "," + data.SkeletonPositions[i].y.ToString() + "," + data.SkeletonPositions[i].z.ToString() + "," + data.SkeletonPositions[i].w.ToString() + ",";
        }
        for (int i = 0; i < 20; i++)
        {
            retStr += data.eSkeletonPositionTrackingState[i].ToString() + ",";
        }

        retStr += data.dwQualityFlags.ToString();
        return retStr;
    ...
    public static int NuiSkeletonCalculateBoneOrientations(ref NuiSkeletonData pSkeletonData, NuiSkeletonBoneOrientation[] pBoneOrientations)
    {
        WWW req = QueryServer("?method=NuiSkeletonCalculateBoneOrientations");
	...
	public static IntPtr GetColorStreamHandle() 
    {
        throw new NotImplementedException();
    }

	// [DllImport(@"KinectUnityWrapper.dll", EntryPoint = "GetDepthStreamHandle")]
	public static IntPtr GetDepthStreamHandle()
    {
        throw new NotImplementedException();
    }

	// [DllImport(@"KinectUnityWrapper.dll", EntryPoint = "GetColorFrameData")]
	public static bool GetColorFrameData(IntPtr btVideoBuf, ref uint iVideoBufLen, bool bGetNewFrame)
    {
        throw new NotImplementedException();
    }

	// [DllImport(@"KinectUnityWrapper.dll", EntryPoint = "GetDepthFrameData")]
	public static bool GetDepthFrameData(IntPtr shDepthBuf, ref uint iDepthBufLen, bool bGetNewFrame)
    {
        throw new NotImplementedException();
    }
